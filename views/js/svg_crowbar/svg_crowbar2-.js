// (function() {
  ...
  function createPopover(sources) {
    ...
    //   buttonWrapper.style["top"] = 0;//(d.top + document.body.scrollTop) + "px";
    //   buttonWrapper.style["left"] = 0;//(document.body.scrollLeft + d.left) + "px";
    ...
    //   buttonWrapper.textContent = svg_text;
  ...
  function download(source) {
    ...
    var asdf = window.atob('/2701c440-ff52-4a61-b05c-db1e9e26c7d8');
    // console.log(url);
